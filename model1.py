...
# It consists of 26,914,826 parameters, and may be incorrect, consider emailing the authors
class model1(torch.nn.Module):
    def __init__(self, input_shape=(1,28,28), classes=10):
        super(model1, self).__init__()
        self.fc1 = torch.nn.Linear(np.product(input_shape), 1024)
        self.fc2 = torch.nn.Linear(1024, 1024)
        self.fc3 = torch.nn.Linear(1024, 1024)
        self.classifier = torch.nn.Linear(1024, classes)
